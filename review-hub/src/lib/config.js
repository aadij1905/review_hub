...
// ─────────────────────────────────────────────────────────────────────────────
export const AI_URL =
  "https://wisdom-raises-admitted-telecommunications.trycloudflare.com"; // cloudflare tunnel -> local ai-service (rate-limited on Railway)
// "http://localhost:5001";
// "https://ai-service-production-b7c5.up.railway.app"; // ai service 2
export const ANALYTICS_URL =
  "https://else-passive-ebooks-ciao.trycloudflare.com"; // cloudflare tunnel -> local analytics-service
// "http://localhost:4000";
