...
const ITEMS = [
  {
    ...
    impactForecast: {
      metric: "conversion",
      revenueMonthly: { low: 950, high: 2500 },
      ordersMonthly: { low: 11, high: 29 },
      headline: "+$950–$2.5K/mo",
      deltaLabel: "+11–29 orders/mo",
      basis: "42,180 sessions/30d site-wide at 0.87% conversion",
      assumptions: [
        "A conservative 3–8% relative lift in site-wide conversion",
        "At your average order value of $72",
        "Scaled to 30 days from a 30-day window",
      ],
      modeled: true,
    },
  ...
  },
  {
    ...
    impactForecast: {
      ...
      revenueMonthly: { low: 3500, high: 8500 },
      ordersMonthly: { low: 49, high: 118 },
      headline: "+$3.5K–$8.5K/mo",
      deltaLabel: "+49–118 orders/mo",
      basis: "980 sessions/30d reach checkout but don't complete",
      assumptions: [
        "Recovering 5–12% of the 980-session checkout drop-off",
        "At your average order value of $72",
        "Scaled to 30 days from a 30-day window",
      ],
      modeled: true,
...
{%- endif -%}`,
  ...
  },
  {
    ...
    impactForecast: {
      metric: "speed-driven conversion",
      revenueMonthly: { low: 110, high: 270 },
      ordersMonthly: { low: 2, high: 4 },
      headline: "+$110–$270/mo",
      deltaLabel: "+2–4 orders/mo",
      basis: "8,640 sessions/30d on /products/signature-hoodie at 0.87% conversion",
      assumptions: [
        "A conservative 2–5% relative lift in /products/signature-hoodie conversion",
        "At your average order value of $72",
        "Scaled to 30 days from a 30-day window",
      ],
      modeled: true,
...
{%- endif -%}`,
  ...
  },
  {
    ...
    impactForecast: {
      metric: "conversion",
      revenueMonthly: { low: 120, high: 320 },
      ordersMonthly: { low: 2, high: 4 },
      headline: "+$120–$320/mo",
      deltaLabel: "+2–4 orders/mo",
      basis: "6,310 sessions/30d on /collections/sale at 0.87% conversion",
      assumptions: [
        "A conservative 3–8% relative lift in /collections/sale conversion",
        "At your average order value of $72",
        "Scaled to 30 days from a 30-day window",
      ],
      modeled: true,
  ...
  },
  {
    ...
    impactForecast: {
      metric: "conversion",
      revenueMonthly: { low: 530, high: 1600 },
      ordersMonthly: { low: 7, high: 22 },
      headline: "+$530–$1.6K/mo",
      deltaLabel: "+7–22 orders/mo",
      basis: "42,180 sessions/30d site-wide at 0.87% conversion",
      assumptions: [
        "A conservative 2–6% relative lift in site-wide conversion",
        "At your average order value of $72",
        "Scaled to 30 days from a 30-day window",
      ],
      modeled: true,
